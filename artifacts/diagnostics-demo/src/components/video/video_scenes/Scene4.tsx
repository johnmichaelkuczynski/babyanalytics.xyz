  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="text-[3vw] font-display text-white tracking-widest uppercase mb-2">Data 101</h1>
        <p className="text-[1.2vw] text-[var(--color-accent)] italic font-display text-2xl tracking-widest">The Data Studio</p>
      </motion.div>
    </motion.div>
  );
}